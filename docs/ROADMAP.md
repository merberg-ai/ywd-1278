...
- [x] 0B-P10 deterministic packet-capable YWD-1278 AX25R3 firmware build from frozen engineering source — exact `d25180ad663d781b761c525d1e699e7b052d621d1e699e7b052d6214` lineage, product branding made no behavioral changes after AX25R3, two independent builds were byte-identical, artifact size `59812`, SHA256 `a069d9a9f1c3d5014984e5d73a5b57155ffa50f8908c9d80c5da221b8ea07310`; the twelve exact engineering blobs are now vendored and Git-blob-verified inside YWD-1278 so reproducing the build no longer requires a YWD-MMDVM checkout
...
- [ ] 0C-P7 guarded KISS DATA admission -> per-request P6 parameter snapshot -> bounded queue -> live P2/P1 channel access -> qualified P4e half-duplex TX; first physical KISS-originated TX packet must use `VIA YWDNOD`, while `YWDNOD*` repeat proof remains deferred/non-blocking
