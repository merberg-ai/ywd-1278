...
- [ ] 0B-P13b guarded single known-packet YWD TX on 145.050 MHz with independent external decoder/receiver proof — **staged/CI-green** with frozen one-shot `KJ6YWD-10>YWD13B:YWD-1278 P13B SINGLE TX TEST`, 753 selectors, expected 12048 generated samples, one submission maximum, no automatic retry, and ordinary KISS/product TX still disconnected
