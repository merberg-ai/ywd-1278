...
- [ ] 0C-P7 physical KISS-originated one-shot qualification — separately stage exactly one packet on 145.050 MHz / RF power 200 through the qualified P7 graph, requiring literal `VIA YWDNOD` and direct independent external decode; `YWDNOD*` repeat proof remains deferred/non-blocking
