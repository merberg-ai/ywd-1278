...
- [ ] live YWD_RX owner qualification — packet-capable YWD-1278 firmware is now physically qualified by P11; next live receive gate may proceed under an RX-only runtime
...
- [ ] 0B-P12 requalify physical live RX through assembled product runtime
