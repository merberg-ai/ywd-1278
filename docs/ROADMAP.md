...
- [ ] channel-busy/recent-RX detection (0C-P2) — AX25R4 raw RSSI telemetry candidate source is staged/CI-green and fully self-contained in YWD-1278; the target Pi produced two byte-identical builds of the exact candidate, size `59892`, SHA256 `b06fcbf0baa36e865198091cee27c66e1624ef08117ee685253a7a5613c7c616`, identity `MMDVM_HS_Hat-YWD-1278-AX25R4-v0.1.0-alpha1 ...`; exact artifact is now locked and a guarded physical live-RSSI activation is staged from the exact P13b AX25R3 base with automatic exact-AX25R3 rollback and protected-stock fallback; physical AX25R4 activation has **not** yet run, no carrier threshold/hysteresis is selected, P13b remains the latest physical boundary, and KISS/product TX stays disconnected
- [ ] TXDELAY
- [ ] PERSIST
- [ ] SLOTTIME
