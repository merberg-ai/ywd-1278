...
- [ ] guarded physical channel-access-controlled TX through the real POSIX modem transport, with independently decoded over-air proof and no KISS-originated TX yet (0C-P4d)
- [ ] TXDELAY
- [ ] PERSIST
- [ ] SLOTTIME
