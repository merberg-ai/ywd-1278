...
- [ ] 0C-P8 guarded physical sustained KISS TNC qualification — separately prove multiple ordinary KISS TCP DATA frames across repeated real RX/CSMA/TX/RX cycles, disconnect/reconnect behavior and post-TX RX recovery on the installed AX25R4 firmware. Qualification packets must use literal `VIA YWDNOD`; `YWDNOD*` repeat proof remains deferred/non-blocking
