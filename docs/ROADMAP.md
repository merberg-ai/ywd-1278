...
- [ ] guarded physical P4e multi-cycle RX/TX/RX restart qualification with fixed frames and continued post-TX receive proof; KISS-originated TX remains disconnected
- [ ] TXDELAY
- [ ] PERSIST
- [ ] SLOTTIME
