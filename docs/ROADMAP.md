...
- [ ] 0C-P8 sustained bounded KISS TNC operation — multi-frame queue/load/drop behavior, normal RX/TX service lifecycle, client disconnect/reconnect handling, and operator-visible accounting under real TNC use
